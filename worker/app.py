...
# MVP is impact-first. Reinforcing contributes only a very small amount.
MVP_WEIGHTS = {'kills':1.00,'assists':0.45,'deaths':-0.55,'headshots':0.15,'plants':1.25,'defusals':1.50,'entryKills':0.75,'entryDeaths':-0.35,'clutches':2.00,'impact':1.00,'reinforcements':0.05}
